...
export default function MenuLateral({ children }) {
    ...
    const opçõesFazendeiro = [
        ...
        { label: "Menu", items: [
            ...
            { label: "Cadastrar Fazendeiro", command: () => navegar("/cadastrar-fazendeiro")},
    ...
    function opçõesMenu() {
        switch (usuárioLogado.perfil) {
            case "fazendeiro": return opçõesFazendeiro;
            case "transportador": return opçõesTransportador;
            default: return;
        }
    };
